...
base_instruction = load_file_content("agents/competitor_spy/instructions.txt") + competitor_list
agent_description = load_file_content("agents/competitor_spy/description.txt")
...
sitemap_analyzer_1 = LlmAgent(
    ...
    instruction="You are a Competitor Intelligence Agent You will analyze only the 1st competitor's sitemap." + base_instruction,
...
sitemap_analyzer_2 = LlmAgent(
    ...
    instruction="You are a Competitor Intelligence Agent You will analyze only the 2nd competitor's sitemap." + base_instruction,
    description=agent_description,
...
sitemap_analyzer_3 = LlmAgent(
    ...
    instruction="You are a Competitor Intelligence Agent You will analyze only the 3rd competitor's sitemap." + base_instruction,
    description=agent_description,
...
sitemap_analyzer_4 = LlmAgent(
    ...
    instruction="You are a Competitor Intelligence Agent You will analyze only the 4th competitor's sitemap." + base_instruction,
    description=agent_description,
...
sitemap_analyzer_5 = LlmAgent(
    ...
    instruction="You are a Competitor Intelligence Agent You will analyze only the 5th competitor's sitemap." + base_instruction,
    description=agent_description,
